...
typedef SESSION_ID (*FUNC_HTTP_SESSION_CREATE)(CHAR_T *url,BOOL_T is_persistent);
typedef OPERATE_RET (*FUNC_HTTP_SESSION_SEND)(SESSION_ID session,http_req_t *req,http_hdr_field_sel_t field_flags);
