...
***********************************************************/
_UNI_MSG_QUEUE_EXT \
OPERATE_RET RegisterMsgCb(IN CONST MSG_QUE_HANDLE msgQueHandle,IN CONST MSG_ID msgID,\
...
/***********************************************************
*  Function: GetFreeMsgId 
*  Input: msgQueHandle
*  Output: msg_id
*  Return: OPERATE_RET
***********************************************************/
_UNI_MSG_QUEUE_EXT \
OPERATE_RET GetFreeMsgId(IN CONST MSG_QUE_HANDLE msgQueHandle,OUT MSG_ID *msg_id);
