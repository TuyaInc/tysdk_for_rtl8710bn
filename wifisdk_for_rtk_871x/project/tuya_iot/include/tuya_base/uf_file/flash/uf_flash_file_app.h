...
***********************************************************/
__UF_FLASH_FILE_APP_EXT \
OPERATE_RET uf_file_write(VOID *fd,CONST UCHAR_T *data,CONST UINT_T len,UINT_T *write_len);
...
***********************************************************/
__UF_FLASH_FILE_APP_EXT \
OPERATE_RET uf_file_get_file_size(IN CONST UCHAR_T *name,OUT UINT_T *size);
