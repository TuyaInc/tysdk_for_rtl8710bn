...
#BUILD_TYPE=8710_1M
#BUILD_TYPE=8710_2M
BUILD_TYPE=8710_2M_SECURITY_CHIP
...
if [ "$USER_DEF_CMD" = "package" ];then
	...
	./package $BIN_QIO $BIN2 GCC-RELEASE/system_qio.bin $BIN4 $BIN5
	echo "package QIO file success"
	
	./package $BIN_DOUT $BIN2 GCC-RELEASE/system_dout.bin $BIN4 $BIN5
